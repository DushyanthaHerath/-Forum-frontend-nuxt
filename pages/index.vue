    ...
    <v-main>
      <div class="inspire-background">
        ...
        <v-container class="fill-height px-4 py-12">
          <v-card
            class="align-center d-flex justify-center fill-height col-12"
            color="transparent"
          >
            <v-card
            ...
            >
              <div class="d-flex flex-column">
                <v-card class="d-flex flex-column elevation-0 box-title" color="transparent">
                  <div class="text-h2 font-weight-light white--text">
                    Another
                  </div>
                  <div class="text-h2 font-weight-light grey lighten-5--text">
                    Tech
                  </div>
                  <div class="text-h2 font-weight-light white--text">
                    Community
                  ...
                  <p class="font-weight-light white--text">
                    Here you can ask questions, find answers and connect with other users in our community.
                    Some Content and links provided in this Support Community may be linked to outside websites.
                  </p>
                </v-card>
                <v-card class="d-flex justify-right white" tile>
                <v-btn
                  x-large
                  tile
                  color="success"
